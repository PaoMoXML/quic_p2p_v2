...
#[serde(bound(
    serialize = "T::MessageId: Serialize, T::MessagePayload: Serialize",
    deserialize = "T::MessageId: Deserialize<'de>, T::MessagePayload: Deserialize<'de>"
))]
...
#[cfg_attr(
    feature = "serde",
    serde(bound(
        serialize = "T::NodeId: Serialize, T::MessageId: Serialize, T::MessagePayload: Serialize",
        deserialize = "T::NodeId: Deserialize<'de>, T::MessageId: Deserialize<'de>, T::MessagePayload: Deserialize<'de>"
    ))
)]
...
#[cfg_attr(
    feature = "serde",
    serde(bound(
        serialize = "T::NodeId: Serialize, T::MessageId: Serialize",
        deserialize = "T::NodeId: Deserialize<'de>, T::MessageId: Deserialize<'de>"
    ))
)]
...
#[cfg_attr(
    feature = "serde",
    serde(bound(
        serialize = "T::NodeId: Serialize",
        deserialize = "T::NodeId: Deserialize<'de>"
    ))
)]
